...
//case class TransformationProcess(dataFrame:DataFrame, propertyFile:String, logger:Logger, hashMap: Map[String, String], curTime:String) extends sparkEngine with App {

  object TransformationProcess extends sparkEngine with App {
